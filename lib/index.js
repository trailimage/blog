 ...
 * @namespace
 * @name RootNamespace
 * @property {ProviderManager} active
 * @property {PdfNamespace} PDF
 * @property {ProviderNamespace} Provider
 * @property {MiddlewareNamespace} Middleware
 * @property {exports|module.exports} enum
 * @property Mock
 */
class RootNamespace {
