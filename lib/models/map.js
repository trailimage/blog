...
exports.loadGPX = function(slug, callback)
{
	...
	db.getObject(key, slug, callback);
};
...
{
	addPhotos({ type: 'FeatureCollection', features: [] }, post, callback);
};
...
function addPhotos(geo, post, callback)
{
	post.getPhotos(function()
	{
		...
		if (post.nextIsPart)
		{
			addPhotos(geo, post.next, callback);
		}
		else
		{
			callback();
