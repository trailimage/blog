...
function view(res, viewKeys, apiKeys, mapKeys, logs) {
    ...
    res.render(template_1.default.page.ADMINISTRATION, {
        ...
        json: is_1.default.array(apiKeys) ? apiKeys.sort() : null,
...
function home(req, res) {
    ...
    Promise.all([
        ...
        apiKeys = (is_1.default.array(apiKeys)) ? apiKeys.map(j => j.replace(_1.default.api.prefix, '')) : [];
        view(res, viewKeys, apiKeys, mapKeys, logs);
    });
}
function updateLibrary(req, res) {
    return _1.default.api.remove(flickr_1.default.cache.keysForLibrary).then(() => library_1.default.load(false)
        .then(() => {
