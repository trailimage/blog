...
//const Book = Blog.PDF.Book;
//const Layout = Blog.PDF.Layout;
//const Page = Blog.PDF.Page;
const fs = require('fs');
 ...
 * @returns {Blog.PDF.Page}
 */
function makeCover(post) {
	const Rectangle = Blog.PDF.Element.Rectangle;
...
function makePhotoPage(photo, number) {
	const PhotoWell = Blog.PDF.Element.PhotoWell;
	const PhotoCaption = Blog.PDF.Element.Caption;
