...
const ElementArea = require('../elements/element-area.js');
...
class PDFElement {
	 ...
	 */
	positionWithin(area) {
		if (!isNaN(this.bottom) && this.area.toplessHeight) {
	 ...
	 * @param {ElementArea} area
	 */
	updateLayout(layout, area) { layout.applyTo(this); }

	/**
	 * @param {PDFLayout} layout
	 * @param {function} [callback]
	 */
	render(layout, callback) { this.updateLayout(layout, this.area); }
