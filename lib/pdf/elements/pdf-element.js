...
class PDFElement {
	...
	constructor(style) {
		...
		/**
		 * Dimensions
		 * @namespace TI.PDF.Element.Base.area
		...
		this.minHeight = NaN;
		/**
		 * @namespace TI.PDF.Element.Base.alignContent
		 * @type {String}
		 */
	...
	/**
	 * Width in pixels
	 * @namespace TI.PDF.Element.Base.widthPixels
	 * @returns {Number}
	 */
	...
	/**
	 * Height in pixels
	 * @namespace TI.PDF.Element.Base.heightPixels
	 * @returns {Number}
	 */
