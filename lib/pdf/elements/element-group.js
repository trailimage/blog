...
class ElementGroup extends PDFElement {
	...
	/**
	 * Add child element
	 * @param {PDFElement|TextElement|ImageElement|PhotoWell|PhotoCaption|RectangleElement|ElementGroup} el
	 * @return {PDFElement|TextElement|ImageElement|PhotoWell|PhotoCaption|RectangleElement|ElementGroup}
	 */
