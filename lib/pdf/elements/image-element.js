...
class ImageElement extends PDFElement {
	...
	scale(maxWidth, maxHeight) {
		switch (this.scaleTo) {
			case Layout.Scale.Fit: this.fit(maxWidth, maxHeight); break;
			case Layout.Scale.Fill: this.fill(maxWidth, maxHeight); break;
			default: super.scale(maxWidth, maxHeight); break;
		}
	}
