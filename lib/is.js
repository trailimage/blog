...
const number = n => value(n) && typeof(n) === type.numberType;
const integer = n =>  value(n) && typeof(n) === type.numberType;
const bigInt = n => integer(n) && (n < -32768 || n > 32767);

module.exports = {
	value,
   // http://jsperf.com/hasownproperty-vs-in-vs-other/16
	defined(object, field) { return typeof(object[field]) !== type.undefinedType; },
   number,
   integer,
   bigInt,
   int64: bigInt,
	...
	text(v) { return typeof(v) === type.stringType; },
