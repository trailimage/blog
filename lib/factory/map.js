...
exports.track = (postKey) => config_1.default.cache.maps
    ? cache_1.default.map.getItem(postKey).then(item => is_1.default.cacheItem(item) ? item : loadTrack(postKey))
    : loadTrack(postKey);
exports.photos = () => config_1.default.cache.maps
    ? cache_1.default.map.getItem(BLOG_JSON_KEY).then(item => is_1.default.cacheItem(item) ? item : loadPhotos())
    : loadPhotos();
