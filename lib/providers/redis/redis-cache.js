...
const CacheBase = require('../../cache/cache-base');
const CacheItem = require('../../cache/cache-item');
...
class RedisCache extends CacheBase {
	...
	constructor(redisUrl) {
		...
		this.client.on('connect', () => {
			log.info("Redis connected to %s:%d", url.hostname, url.port);
			this.connected = true;
	...
	authorize(auth) {
		...
		log.info("Authenticating Redis connection");
	...
	normalize(value) {
		if (typeof value == 'object') {
			if (value instanceof CacheItem) { value.buffer = buffer.toString('hex'); }
