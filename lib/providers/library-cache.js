 ...
 * Load library and all its posts before writing out to cache
 */
class LibraryCache {
	/**
	 ...
	 */
	static getPhotoTags(callback) { cache.getObject(tagsKey, callback); }
	 ...
	 */
	static removePhotoTags(callback) { cache.remove(tagsKey, callback);	}
