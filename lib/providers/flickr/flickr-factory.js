 ...
 * @extends Blog.Factory.Base
 * @alias TI.Factory.Flickr
 */
class FlickrFactory extends FactoryBase {
	...
	/**
	 * @param {Blog.Library} library New or existing library
	...
	_addCollection(library, collection, excludeSets, root, featureSets) {
		...
		if (collection.collection) {
			...
			collection.collection.forEach(c => { t.addChild(this._addCollection(library, c, excludeSets)); });
		}
