...
class FlickrPhoto extends PhotoProviderBase {
	 ...
	 * @param {function(Blog.EXIF)} callback
	 ...
	 * @param {function(Blog.Library)} callback
	 ...
	 * @param {String|Blog.Post} postOrID
	 * @param {function(Blog.Post)} callback
	 ...
	 * @param {function(Blog.Photo[])} callback
	 */
	...
	/**
	 * @param {String} photoID
	 * @param {function(Blog.PhotoSize[])} callback
	 */
