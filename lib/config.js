...
const Enum = require('@trailimage/enum');
...
/**
 * Configuration for referral spam blocking middleware
 * @see Blog.Middleware.referralBlocker
 */
...
exports.site = {
	...
	postAlias: 'Adventure',
	postTagAlias: 'Subcategories',
	logo: {
		url: 'http://www.trailimage.com/img/logo-large.png',
		width: 200,
		height: 200
	}
};
...
/** @type String */
exports.contactLink = `<a href="mailto:${exports.owner.email}">Contact</a>`;
...
/**
 * @alias TI.config.style
 */
exports.style = {
	icon: {
		haiku: Enum.icon.leaf,
		/**
		 * Match post tag names to Bootstrap icon names
		 * @type Object<String,String>
		 */
		postTag: {
			'Who': Enum.icon.user,
			'What': Enum.icon.road,
			'When': Enum.icon.calendar,
			'Where': Enum.icon.globe,
			'default': Enum.icon.tag
		},
		/**
	...
	map: {
		/**
		 * Maximum height of static maps displayed with post summaries
		 */
		maxInlineHeight: 200
	},
	css: {
		/**
		 * @see post-tag-page.less
		 */
		postTagHeader: 'post-tag-header'
	},
	/**
...
exports.library = {
	...
	/**
	 * Root tag displayed on home page
	 */
	defaultPostTag: 'When'
};
...
/**
 * @type String
 * @alias TI.config.alwaysKeywords
 * @const
 */
exports.alwaysKeywords = 'Adventure, Scenery, Photography,';

/**
 * @type String
 * @alias TI.config.keywords
 * @const
 */
