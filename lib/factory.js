...
/**
 * Update photoMarkers property
 * @this {Post}
 * @see https://www.mapbox.com/api-documentation/#static
 * For marker format
 * @see https://www.mapbox.com/developers/api/v3/static/
...
function updatePhotoMarkers() {
   ...
   for (let i = start; i < total; i++) {
      ...
      if (img.latitude > 0) {
         markers += `,url-${encodeURIComponent('http://www.trailimage.com/img/red-marker.png')}(${img.longitude.toFixed(5)},${img.latitude.toFixed(5)})`;
      }


      https://www.dropbox.com/s/oq6d38fr6tat1he/p.png?dl=0
   }
