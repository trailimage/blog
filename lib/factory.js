 ...
 * @return {Promise.<String[]>} Resolve with list of changed post keys
 */
function buildLibrary(emptyIfLoaded = true) {
   let existingPostKeys = (library.loaded) ? library.postKeys() : [];
...
//  * @returns {Promise.<String[]>} Resolve with list of changed post keys
//  */
