...
exports.remove = function(key, p2, p3)
{
	...
	else if (p3 !== undefined || !(p2 instanceof Function))
	{
		...
		{
			redis.hdel(key, p2, responder(key, callback, replyType.count));     // http://redis.io/commands/hdel
		}
	}
	else
	{
...
exports.add = function(key, p2, p3, p4)
{
	...
	{
		redis.hset(schematize(key), p2, normalize(p3), responder(key, p4, replyType.bit));  // http://redis.io/commands/hset
	}
