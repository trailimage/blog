 ...
 * @namespace
 * @name CacheNamespace
 * @property {CacheBase} Base
 * @property {CacheHelper} Helper
 * @property {CacheItem} Item
 * @property {MemoryCache} Memory
 * @property {ModelCache} Model
 * @property {RedisCache} Redis
 * @property {SqlCache} SQL
 */
