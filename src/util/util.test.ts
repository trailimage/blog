...
describe('Utilities', () => {
   describe('Date and Time', () => {
      it('display date as MMM d, YYYY', () => {
         ...
         expect(util.date.toString(new Date(1973, 2, 15))).equals(
            'March 15, 1973'
         );
      });
   ...
   describe('HTML', () => {
      it('formats fractions', () => {
         expect(util.html.fraction('1/2')).equals(
      ...
      it('creates HTML for a photo tag list', () => {
         expect(
            util.html.photoTagList(['Second', 'First', 'Third and Last'])
         ).equals(
      ...
      it('substitutes nicer typography', () => {
         ...
         expect(util.html.typography('"He said," she said')).equals(
            '&ldquo;He said,&rdquo; she said'
         );
         expect(
            util.html.typography('<a href="/page">so you "say"</a>')
         ).equals('<a href="/page">so you &ldquo;say&rdquo;</a>');
      });
      ...
      it('shortens link text to domain and URL decoded page', () => {
         ...
         target =
            '<a href="http://youtu.be/QzdSlYoZitU">youtu.be/QzdSlYoZitU</a>';
   ...
   describe('Encoding', () => {
      ...
      it('base 64 encodes text', () => {
         ...
         ).equals('TmVxdWUgcG9ycm8gcXVpc3F1YW0gZXN0IHF1aSBkb2xvcmVtIGlwc3Vt');
      });
      it('base 64 decodes text', () => {
         ...
         ).equals('Neque porro quisquam est qui dolorem ipsum');
      });
   ...
   describe('Icons', () => {
      it('creates material icon tags', () => {
         expect(util.icon.tag('star')).equals(
      ...
      it('matches post categories to material icons', () => {
         ...
         expect(util.icon.category('Test')).equals(
            '<i class="material-icons success">success</i>'
         );
         // revert to default if provided
         expect(util.icon.category('Nothing')).equals(
   ...
   it('extracts top domain from URL', () => {
      expect(util.topDomain('http://www.microsoft.com')).equals(
         'microsoft.com'
      );
      expect(
         util.topDomain(
      ...
      expect(util.topDomain('342342342.copyrightclaims.org')).equals(
         'copyrightclaims.org'
      );
   });
   ...
   describe('Photo Captions', () => {
      ...
      it('identifies footnotes', () => {
         ...
         source =
            lipsum + nl + '___' + nl + '¹ Some other note' + nl + '² Last note';
         target =
            '<p>' +
            lipsum +
